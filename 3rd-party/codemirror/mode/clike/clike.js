...
CodeMirror.defineMode("clike", function(config, parserConfig) {
  var indentUnit = config.indentUnit,
      ...
      number = parserConfig.number || /^(?:0x[a-f_\d]+|(?:[_\d]+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
  ...
  var cKeywords = "if break case continue return default do sizeof " +
    "else struct switch for goto while const " +
    "asm";
  ...
  var basicCTypes = words("long fixed " +
    "void inline register");
